...
1.  **Unit Tests:** Verificam a lógica isolada de cada função.
2.  **Integration Tests:** Simulam a execução completa do pipeline (Leitura → Transformação → Escrita em Disco).
